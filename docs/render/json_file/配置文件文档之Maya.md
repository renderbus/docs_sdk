...
plugins | object | Y | 插件对象。<br>key为插件名称，value为插件版本 | {}
...
os_name | string | 渲染操作系统,:<br>"0":Linux; "1": Windows | "0"
...
stop_after_test | string | 优先渲染完成后是否暂停任务<br>"1":优先渲染完成后暂停任务<br>"2".优先渲染完成后不暂停任务 |"2"
